            ...
            <div {...getRootProps({style: dropZoneReg})}>
              ...
              <div style={{flexGrow: "0"}}>
                <div style={{display: "flex", flexFlow: "column wrap"}}>
                  <Typography variant="p" style={{marginTop: "0.25rem"}}>Optimal Aspect Ratio: 1013/446 (width/height).</Typography>
                  <Typography variant="p" style={{margin: "0.1rem"}}>Don't worry, fren. You can crop on next step.</Typography>
                </div>
              </div>
            </div>
          </div>
